...
import { z } from "zod";
import { cambiarEstadoCategoriaAsesor } from "@/lib/repositories/categorias-asesor";
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    const categoria = await cambiarEstadoCategoriaAsesor(params.id, parsed.data.activo);
