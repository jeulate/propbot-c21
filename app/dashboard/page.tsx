...
import {
  ...
  TarjetaMetricaSaas,
  TarjetaMetricaIcono,
} from "@/components/tarjeta-metrica";
...
export default async function DashboardPage({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="shadow-panel rounded-xl border border-gold-200 bg-white dark:border-carbon-700 dark:bg-carbon-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <TarjetaMetricaSaas
            ...
            variacion={
              metricas.comparativas.totalTransacciones.variacionPorcentual
            }
          />
          ...
          <TarjetaMetricaSaas
            ...
            variacion={
              metricas.comparativas.totalComisiones.variacionPorcentual
            }
          />
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <PanelGrafico
          titulo="Top 10 Colocación"
          descripcion="Ranking por cantidad de cierres registrados."
        >
          <GraficoRanking
            etiqueta="Cierres"
        ...
        <PanelGrafico
          titulo="Top 10 Producer"
          descripcion="Ranking por monto pagado al asesor."
        >
          <GraficoRanking
            etiqueta="Bs"
        ...
        <PanelGrafico
          titulo="Top Captaciones"
          descripcion="Ranking mensual de captaciones por asesor."
        >
          <GraficoRanking
        ...
        <PanelGrafico
          titulo="Top Colocadores"
          descripcion="Asesores con más cierres como colocadores."
        >
          <GraficoRanking
            etiqueta="Cierres"
      ...
      <section className="shadow-panel rounded-xl border border-gold-200 bg-white p-6 dark:border-carbon-700 dark:bg-carbon-800">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="focus-ring text-sm text-gold-600 hover:text-gold-700 dark:text-gold-500 dark:hover:text-gold-300"
          >
            Ver todos →
          </Link>
        </div>
            ...
            <tbody>
              {metricas.ultimosCierres.map((c) => (
                ...
                >
                  ...
                  <td className="py-2.5 pr-4">
                    {formatearFechaHoraBolivia(c.creadoEn)}
                  </td>
              ...
              {metricas.ultimosCierres.length === 0 && (
                <tr>
                  <td
                    colSpan={6}
                    className="py-8 text-center text-carbon-500 dark:text-gold-100/40"
                  >
...
function EstadoBadge({ estado }: { estado: string }) {
  ...
  return (
    <span
      className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${estilos[estado]}`}
    >
      {etiquetas[estado]}
    </span>
  );
